  ...
  return (
    <section id="reservation" >
      ...
      >
        ...
        <fieldset className="res-fieldset">
          <label className="res-label" htmlFor="res-time">Choose time</label>
          <select 
        ...
        <fieldset className="res-fieldset">
          <label className="res-label" htmlFor="guests">Number of guests</label>
          <input 
            className="res-input" 
            type="number" 
            value={resGuest}
        ...
        <fieldset className="res-fieldset">
          <button className="res-submit"  type="submit" value="">Make Your reservation</button>
        </fieldset>
      </form>
    </section>
  )
